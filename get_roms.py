...
urls = {
    ...
    47: "https://archive.org/download/sega-genesis-romset-ultra-usa66666666 6",
    ...
    67: "https://archive.org/download/Various_DOS_Abandonware_Ark",
    68: "pc88",
    69: "pc98",
    70: "pcengine",
    71: "pcenginecd",
    ...
    79: "https://myrient.erista.me/files/Redump/Sony%20-%20PlayStation/",
    80: "roms",
    ...
    113: "https://archive.org/download/dsmbl",
    114: "https://archive.org/download/3ds-cia-undatted-encrypted",
    115: "https://archive.org/download/UnRenamedFiles-AppleI-II-III-GS-Lisa",
    116: "https://archive.org/download/acorn_archimedes",
    117: "https://archive.org/download/tektagt",
    118: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BPhysMod5%5D%20Tables/",
    119: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BPhysMod5%5D%20Tables%20%5BFullScreen%2BWideScreen%5D/",
    120: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BPhysMod5%5D%20Tables%20%5BMODs%2C%20HACKs%5D/",
    121: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BPhysMod%5D%20Tables/",
    122: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BVP1-VP7%5D%20Original%20Tables/",
    123: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BVP1-VP7%5D%20Original%20Tables%20%5BFlipperless%5D/",
    124: "https://archive.org/download/Atari-XEGS-Romset",
    125: "https://archive.org/download/Visual_Pinball_2020-06-20/Visual%20Pinball%20%5BVPXx%5D%20Original%20Tables/",
    126: "https://archive.org/download/nointro.tg-16",
    127: "https://archive.org/download/nintendo-triforce-arcade-iso-collection",
    128: "https://archive.org/download/UnRenamedFiles-TexasInstruments",
    129: "https://archive.org/download/TeknoParrotRoms",
    130: "https://archive.org/download/super-mario-war-1.8-r-7a/Super%20Mario%20War/"
...
EXCLUDED_REGIONS = {
    'HUNGARY', 'KOREA', 'JAPAN', 'JPN', 'EUROPE',
    'EUR', 'SWEDEN', 'GERMANY', 'POLAND', 'ITALY', 'NORWAY'
}

def delete_excluded_files(filename: str) -> bool:
    """
    Delete file if it contains excluded region names.

    Args:
        filename (str): Name of file to check and potentially delete

    Returns:
        bool: True if file was deleted, False if kept or error occurred
    """

    try:
        if any(region in filename for region in EXCLUDED_REGIONS):
            os.remove(filename)
            logging.info(f"Deleted excluded file: {filename}")
            return True
        return False
    except OSError as e:
...
def check_region(filename):
    ...
    dont_want = any(region in filename for region in EXCLUDED_REGIONS)

    if has_usa:  # If it has USA, we want it
        return True
    elif not has_usa and (dont_want):  # If no USA but other regions, skip
        # delete_excluded_files(filename)
        return False
...
"""
    ...
    try:
        ...
        for row in soup.find_all('tr'):
            ...
            if link and 'href' in link.attrs:
                ...
                if href.endswith(('.wsc', '.tic', '.sg', '.zip','.mgw', '.gbc', '.lnx','.gba', '.rar',
                                ...
                                '.png', 'D64', 'T64', 'C64', '.col', '.cas','.afpk','.mp3','.flac', '.cia')):
        ...
        # Write the script
        if len(auto_downloads) or len(large_downloads):
